        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="ui-widget">
                        <input id="query" name="query" placeholder="Pesquisar"
                        ...
                        <table class="table table-hover">
                            ...
                            <?php foreach ($usuarios as $usuario): ?>
                                <tr>
                                    ...
                                    <td><?= $usuario->email; ?></td>
                                    <td><?= $usuario->cpf; ?></td>
                                    <td><?= ($usuario->ativo && $usuario->deletado_em == null) ? '<span class="badge badge-primary">Sim</span>' : '<span class="badge badge-danger">Não</span>'; ?></td>
                                    <td>
                                        <?= ($usuario->deletado_em == null) ? '<span class="badge badge-primary">Disponível</span>' : '<span class="badge badge-danger">Excluído</span>'; ?>
